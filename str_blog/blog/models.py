...
#a = Article(author = aut, category = cat, title = u'美腿写真', en_title = 'meituixiezhen', tags='', summary='', content = '<p><a class="lightview" href="../../../../static/img/[Beautyleg] 美腿寫真 No.1086 Winnie 2015.01.26 [52P]/1.jpg" data-lightview-group-options="controls: { close: false , slider: false },spacing: {relative: { horizontal: 60, vertical: 0 },thumbnails: { horizontal: 60, vertical: 0 },top: { horizontal: 60, vertical: 0 }}," data-lightview-group="example"> <img src="../../../../static/img/thub/1.jpg" alt="" /></a> <a class="lightview" href="../../../../static/img/[Beautyleg] 美腿寫真 No.1086 Winnie 2015.01.26 [52P]/2.jpg" data-lightview-group="example"><img src="../../../../static/img/thub/2.jpg" alt="" /></a> <a class="lightview" href="../../../../static/img/[Beautyleg] 美腿寫真 No.1086 Winnie 2015.01.26 [52P]/3.jpg" data-lightview-group="example"> <img src="../../../../static/img/thub/3.jpg" alt="" /></a></p><p><a class="lightview" href="../../../../static/img/[Beautyleg] 美腿寫真 No.1086 Winnie 2015.01.26 [52P]/4.jpg" data-lightview-group="example"> <img src="../../../../static/img/thub/4.jpg" alt="" /></a><a class="lightview" href="../../../../static/img/[Beautyleg] 美腿寫真 No.1086 Winnie 2015.01.26 [52P]/5.jpg" data-lightview-group="example"><img src="../../../../static/img/thub/5.jpg" alt="" /></a></p>', pub_time = timezone.now())
class Article(models.Model):
    ...
    create_time = models.DateTimeField(u'创建时间',blank=True,auto_now_add=True)
    update_time = models.DateTimeField(u'更新时间',auto_now=True)

    def get_tags(self):
        return self.tags.split(',')
    def get_desp(self):
        return self.content[3:80]
